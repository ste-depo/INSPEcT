...
knitr::include_graphics("INSPEcT_GUI_figures/select_INSPEcT_object_class_gene.png", dpi=120)
```
...
knitr::include_graphics("INSPEcT_GUI_figures/rates_and_concentrations_panel.png", dpi=120)
```
...
knitr::include_graphics("INSPEcT_GUI_figures/minimization_status.png", dpi=120)
```
...
knitr::include_graphics("INSPEcT_GUI_figures/case_study_1.png", dpi=120)
```
...
knitr::include_graphics("INSPEcT_GUI_figures/case_study_3.png", dpi=120)
```
