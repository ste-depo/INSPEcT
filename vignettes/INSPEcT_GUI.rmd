...
```{r fig1,eval=TRUE,echo=FALSE, fig.width=15, fig.cap="Representation of the GUI divided into its 4 main sections.", fig.align="center"}
knitr::include_graphics("INSPEcT_GUI_figures/INSPEcT_GUI.png", dpi=120)
```
...
```{r fig2,eval=TRUE,echo=FALSE, fig.width=5, fig.cap="Interaction with an object of class INSPEcT (section 1).", fig.align="center"}
knitr::include_graphics("INSPEcT_GUI_figures/select_INSPEcT_object_class_gene.png", dpi=1200)
```
...
```{r fig3,eval=TRUE,echo=FALSE, fig.width=5, fig.cap="Visualization of the RNA dynamics for a single gene (section 2).", fig.align="center"}
knitr::include_graphics("INSPEcT_GUI_figures/rates_and_concentrations_panel.png", dpi=240)
```
...
```{r fig4,eval=TRUE,echo=FALSE, fig.width=5, fig.cap="Model minimization (section 3).", fig.align="center"}
knitr::include_graphics("INSPEcT_GUI_figures/minimization_status.png", dpi=1200)
```
...
```{r fig5,eval=TRUE,echo=FALSE, fig.width=5, fig.cap="Direct interaction with RNA life-cycle kinetic rates (section 4).", fig.align="center"}
knitr::include_graphics("INSPEcT_GUI_figures/rates_functional_forms.png", dpi=120)
```
...
```{r fig6,eval=TRUE,echo=FALSE, fig.width=5, fig.cap="Case study 1: constant kinetic rates.", fig.align="center"}
knitr::include_graphics("INSPEcT_GUI_figures/case_study_1.png", dpi=118)
```
...
```{r fig7,eval=TRUE,echo=FALSE, fig.width=5, fig.cap="Case study 2: modulation of processing rate.", fig.align="center"}
knitr::include_graphics("INSPEcT_GUI_figures/case_study_2.png", dpi=120)
```
...
```{r fig8,eval=TRUE,echo=FALSE, fig.width=5, fig.cap="Case study 3: modulation of synthesis rate.", fig.align="center"}
knitr::include_graphics("INSPEcT_GUI_figures/case_study_3.png", dpi=121)
```
...
```{r fig9,eval=TRUE,echo=FALSE, fig.width=5, fig.cap="Case study 4: concomitant modulation of synthesis and degradation rates.", fig.align="center"}
knitr::include_graphics("INSPEcT_GUI_figures/case_study_4.png", dpi=120)
```
