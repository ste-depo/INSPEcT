...
\section{Introduction}
  ...
  The functions returns a list containing exonic/intronic expressions and variances, as well as exonic/intronic 
  ...
  \nonumber
    \frac{P_{T}}{M_{T}} = \frac{P_{T}}{T_{T} - P_{T}} = \frac{k_3}{k_2} \\
  \end{equation}

  However, even from this aggregated quantity, valuable information regarding the differential post transcriptional regulation of 
  genes in different samples can still be obtained.\\
