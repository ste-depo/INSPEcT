...
\section{Introduction}
  ...
  matureInspObj_sim3<-makeSimDataset(object=simRates
                                   ...
                                   ,NoNascent=TRUE
                                   ,seed=1)
  modelSelection(matureInspObj_sim3)$thresholds$chisquare <- 1
  ...
  matureInspObj_sim4<-makeSimDataset(object=simRates
                                   ...
                                   ,NoNascent=TRUE
                                   ,seed=1)
  modelSelection(matureInspObj_sim4)$thresholds$chisquare <- 1
  ...
  title("3rep. 10t.p. Total and nascent RNA", line=3)
  
  rocCurve(simRates[1:100],nascentInspObj_sim4)
  title("4rep. 12t.p. Total and nascent RNA", line=3)
  
  rocCurve(simRates[1:100],matureInspObj_sim3)
  title("3rep. 10t.p. Total RNA", line=3)
  
  rocCurve(simRates[1:100],matureInspObj_sim4)
  title("4rep. 12t.p. Total RNA", line=3)
  ...
  of the chi-squared and Brown test can be modified by the \Rmethod{modelSelection}.
