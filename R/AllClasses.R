...
#' is a package that analyse Nascent-seq and RNA-seq time-course data in order to evaluate synthesis, 
...
#' fators used for RNA- (totalSF) and Nascent-seq libraries (labeledSF). A list of parameters that will be used during the 
